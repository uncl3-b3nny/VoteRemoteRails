...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference("Election.count") do
      post elections_url, params: { election: { name: @election.name, ownerDID: @election.ownerDID } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { name: @election.name, ownerDID: @election.ownerDID } }
